    ...
    <div className='flex flex-col'>
      ...
      <main className='flex-grow md:mb-12'>
        ...
        <section className='flex flex-col h-[200px]'>
            <h2 className='text-lg text-white mt-4 mx-8 md:text-2xl md:mb-4 md:mx-16 lg:text-3xl lg:mx-24'>Skill blandas</h2>
            <h2 className='text-sm text-white mx-8 md:text-lg md:mx-16 lg:text-xl lg:mx-24 lg:mt-4'>
